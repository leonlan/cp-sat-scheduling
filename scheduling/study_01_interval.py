...
# Constraint: End - Start = Duration V.S. Using new_interval_var
...
def run_model_1(num_tasks):
    ...
    # Sequence optimizing
    literals = {(t1, t2): model.new_bool_var(f"{t1} -arc-> {t2}") for t1 in tasks for t2 in tasks if t1!=t2}
...
if __name__ == '__main__':
    ...
    plt.plot(sizes_2, model_2_times, '-.', marker='o', label='With new_interval_var')
    plt.legend()
